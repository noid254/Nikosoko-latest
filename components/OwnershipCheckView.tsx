    ...
    return (
        <div className="bg-gray-50 min-h-screen font-sans flex flex-col">
            <header className="p-4 bg-white shadow-sm flex items-center gap-4 sticky top-0 z-10">
                ...
                <h1 className="text-xl font-bold text-gray-800">Confirm Asset Ownership</h1>
            </header>
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border">
                    ...
                    <form onSubmit={handleSearch} className="space-y-3">
                        <input 
                            ...
                            className="w-full p-3 border rounded-lg bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-brand-gold transition"
                            autoFocus
                        />
                        <button type="submit" disabled={isLoading} className="w-full bg-brand-navy text-white font-bold py-3 px-4 rounded-lg disabled:bg-gray-400 hover:opacity-90 active:scale-95 transition-all">
