                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-white p-4 rounded-xl shadow-sm border">
                                ...
                                <input 
                                    ...
                                    className="w-full p-3 border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-brand-gold mb-3 text-gray-900 placeholder-gray-400"
                                />
                                ...
                                <div className="space-y-3">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            className="w-full p-3 border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-brand-gold text-gray-900 placeholder-gray-400"
                                        />
                                    </div>
                                    <button 
                            ...
                            <div className="bg-white p-4 rounded-xl shadow-sm border space-y-4">
                                <div>
                                    ...
                                    <select 
                                        ...
                                        className="w-full p-3 border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-brand-gold text-gray-900"
                                    >
