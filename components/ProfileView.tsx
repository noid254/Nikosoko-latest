                        ...
                        <div className="space-y-2 bg-white p-3.5 rounded-2xl border border-gray-200 shadow-xs text-left animate-fade-in">
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full p-2 text-xs font-bold bg-gray-50 border border-gray-200 rounded-xl outline-none focus:bg-white focus:border-black text-gray-900 placeholder-gray-400" 
