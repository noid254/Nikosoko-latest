                    ...
                    <div className="space-y-6 animate-fade-in">
                        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                            ...
                            <select 
                                ...
                                className="w-full p-3 border rounded-lg bg-gray-50 font-semibold text-gray-900 focus:outline-none focus:ring-2 focus:ring-brand-gold"
                            >
                        ...
                        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                            ...
                            <div className="flex items-center gap-2">
                                <input type="time" value={startTime} onChange={e => setStartTime(e.target.value)} className="flex-1 p-3 border rounded-lg bg-gray-50 text-gray-900" />
                                <span className="text-gray-400">to</span>
                                <input type="time" value={endTime} onChange={e => setEndTime(e.target.value)} className="flex-1 p-3 border rounded-lg bg-gray-50 text-gray-900" />
                            </div>
                        </div>
                    ...
                    <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                            ...
                            <textarea 
                                ...
                                rows={4}
                                className="w-full p-3 border rounded-lg bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-brand-gold placeholder-gray-400"
                            />
                        </div>
                    </div>
                )}
