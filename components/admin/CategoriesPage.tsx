    ...
    return (
        <div className="bg-white rounded-lg shadow-sm p-4 max-w-md mx-auto">
            <h2 className="text-lg font-bold text-gray-800 mb-4">Manage Categories</h2>
                ...
                <input type="text" value={newCategory} onChange={(e) => setNewCategory(e.target.value)} placeholder="New category name..." className="flex-grow border rounded-l px-2 py-2 text-sm border-gray-300 focus:ring-brand-primary focus:border-brand-primary text-gray-900 placeholder-gray-400"/>
